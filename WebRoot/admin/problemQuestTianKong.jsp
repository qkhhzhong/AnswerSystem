...
<%
	System.out.println("----------problemQuestTianKong.jsp.jsp------------");
    ...
    <jsp:include page="problemheader.jsp" ></jsp:include>
 	...
 	<div style="margin:0 auto;width: 1000px;">
	  <form action="/AnswerSystem/adminservlet" method="post" onsubmit="return checksubmit()">
	 	...
	 	<input type="hidden" name="pqtype" value="tiankong">
	 	<input type="hidden" name="answerid" value="<%=answerid%>">
	 	<div>
	 		填空题内容：<br><textarea rows="8" cols="80" name="pqcontent" style="font-size: 18px;"></textarea>
	  	</div>
	 	<div>
	 		填空题答案：<br><textarea rows="8" cols="80" name="pqkey" style="font-size: 18px;"></textarea>
	 	</div>
	 	<div><br>设置分值：
 	...
 	<%
	  ...
	  <form id="iddelform<%=i%>" action="/AnswerSystem/mainservlet" method="post">
	  	<input type="hidden" name="action" value="tiankongdelform">
