...
<%
	System.out.println("----------problemResult.jsp------------");
...
<html>
  ...
  <body style="background:url(/AnswerSystem/images/main.jpg);background-size: cover;font-size: 20px;">
    ...
    <jsp:include page="problemResultheader.jsp" ></jsp:include>
 	<br>
...
<%//单选题
 ...
 %>
	  ...
	  <%
	   ...
	   %>  
	  <div><span style="background: #fdd;">你的选择：<%=mysmkey%>---得分：<%=mysmscore%></span></div>
 ...
 %>
	  ...
	  <div style="width: 700px;background:#fae;">
	 	...
	 	<%
	 	 ...
	 	 %> 
	 <div style="width:700px;background: #fdd;">你的答案：<div style="padding-left: 50px;"><%=myskmey%></div></div><br>
